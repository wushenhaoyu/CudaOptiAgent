...
#6. Implementation Intent: For each group, define a "Physical Mapping Strategy" (e.g., Tiled, Grid-Stride, or Warp-Reduction) based on data reuse. Avoid hard-coding if the op is simple.
#
#OUTPUT FORMAT:
#{
#  "task_description": "...",
