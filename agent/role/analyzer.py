...
from utils.utils import extract_recommendation, write_file, read_file
from agent.template.analyzer import INIT_REPAIR_ANALYZER_TEMPLATE
...
#
    ...
    #    hints = extract_recommendation(out)
